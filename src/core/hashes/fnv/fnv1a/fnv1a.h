 ...
 *
 * @return the hash of the given bytes, or {@code -1} if the bytes value is {@code NULL}
 */
 ...
 *
 * @return the hash of the given text, or {@code -1} if the bytes value is {@code NULL}
 */
